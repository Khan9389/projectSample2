...
public class CmmnDao extends SqlSessionDaoSupport {
	...
	@SuppressWarnings("unchecked")
	public <E> PageList<E> selectListPage(String queryId, Object parameterObject, PageInfo pageInfo) {
		return (PageList<E>) getSqlSession().selectList(queryId, parameterObject, new PageBounds(pageInfo));
	}
